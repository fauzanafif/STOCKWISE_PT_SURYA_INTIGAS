...
from utils.dashboard_ui import fmt_num, lineage, nice, page_header, require_db, status_badge
...
if not item_id:
    ...
    st.page_link("app.py", label="← Ke halaman utama", icon="📋")
    st.stop()
...
back = st.session_state.get("detail_origin", "app.py")

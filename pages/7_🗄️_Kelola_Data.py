...
from utils.ingest import ingest_uploads, node_available, rebuild_from_datafix
from utils.dashboard_ui import fmt_num, nice, page_header, recalc_now, setup_status
...
with tab_dq:
    ...
    cc = st.columns(2)
    cc[0].page_link("pages/5_🤝_Cocokkan_Barang.py", label="→ Cocokkan barang", icon="🤝")
    cc[1].page_link("pages/6_🛡️_Safety_Stock.py", label="→ Beresi Safety Stock", icon="🛡️")
